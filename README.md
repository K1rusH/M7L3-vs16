...
**Эта программа предназначена для генерации случайных паролей с заданным количеством символов. Пароли могут содержать заглавные и строчные, цифры и специальные символы.**
